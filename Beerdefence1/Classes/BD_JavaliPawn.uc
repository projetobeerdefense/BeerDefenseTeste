...
class BD_JavaliPawn extends UDNPawn;
var int def;
var int index;
var int maxbarriu;
var int barrlife[6];
...
defaultproperties
{
	...
	Begin Object Class=SkeletalMeshComponent Name=Carroca
        SkeletalMesh=SkeletalMesh'BD_Characters.javali.Javali_com_animacao'
		AnimSets(0)=AnimSet'BD_Characters.javali.javaliset'
        AnimTreeTemplate=AnimTree'BD_Characters.javali.javalianim'
        BlockRigidBody=true
        CollideActors=true
		Rotation=(Pitch=0,Yaw=-32766,Roll=0)// Gira a carroça 90°
